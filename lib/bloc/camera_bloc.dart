...
import 'package:kameradanfileacces/camera_page.dart';
import 'package:kameradanfileacces/storage_helper.dart';
...
class CameraBloc extends Bloc<CameraEvent, CameraState> {
  ...
  Future<void> _onSwitch(
    ...
    final next = s.selectedIndex + 1 > _cameras.length - 1 ? 0 : s.selectedIndex + 1;
